  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Person',
        name: 'Thomas Sander',
        url: 'https://elektroindustrie-stellenangebote.de/#/autor/thomas-sander',
        jobTitle: 'Gruender & Geschaeftsfuehrer',
        worksFor: {
          '@type': 'Organization',
          name: 'Social Media Venture GmbH',
          url: 'https://elektroindustrie-stellenangebote.de',
          address: {
            '@type': 'PostalAddress',
        ...
        description: 'HR-Tech-Experte und Gruender spezialisierter Jobportale fuer Fachkraefte in Deutschland.',
        knowsAbout: ['HR-Tech', 'Recruiting', 'Jobportale', 'Elektroindustrie', 'Personalwesen'],
            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist elektroindustrie-stellenangebote.de zu einer führenden Anlaufstelle für Elektroindustrie-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Elektroindustrie-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Elektroindustrie-Bereich' },
